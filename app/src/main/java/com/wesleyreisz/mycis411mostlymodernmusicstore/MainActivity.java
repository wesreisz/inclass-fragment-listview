...
import com.wesleyreisz.mycis411mostlymodernmusicstore.navigation.NavigationFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadNavigation(new NavigationFragment());
    ...
    private void loadNavigation(Fragment fragment2load) {
        if(findViewById(R.id.fragmentBody)!=null){
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment,fragment2load)
                    .replace(R.id.fragmentBody,new HomeFragment())
                    .commit();
        }else{
            getSupportFragmentManager()
                    .beginTransaction()
